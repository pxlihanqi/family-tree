...
export const metadata = {
    title: `${FAMILY_NAME}生平册`,
    description: `${FAMILY_NAME}家族生平事迹集`,
};

async function BookContent() {
    const { data: members, allMembers, error } = await fetchMembersWithBiography();

    if (error) {
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-cyan-950 to-slate-950">
    ...
    return <BiographyBookLoader members={members} allMembers={allMembers} />;
}
